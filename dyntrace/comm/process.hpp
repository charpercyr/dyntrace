...
namespace dyntrace::comm
{
    ...
    class process_connection : public message_connection<Protocol, dyntrace::proto::process::process_message>
    {
        ...
        using response_type = dyntrace::proto::process::response;
    ...
    protected:
        ...
        void on_message(const message_type& msg) final
        {
            ...
            else if(msg.has_req())
            {
                ...
                message_type msg{};
                msg.set_seq(_next_seq++);
                msg.set_allocated_resp(new response_type{std::move(resp)});
                base_type::send(msg);
            }
        }
        ...
        void on_error(uint64_t seq, const std::exception* e) final
        {
            ...
            msg.mutable_resp()->set_allocated_err(new dyntrace::proto::process::status_error);
